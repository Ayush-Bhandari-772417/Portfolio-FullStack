// admin\src\components\contentpage\ServicesContent.tsx
"use client";
    ...
    return (
      <div className="bg-white rounded-lg shadow p-6">
        <h2 className="text-xl font-bold mb-6">
          {currentItem ? "Edit Service" : "Add Service"}
        </h2>
        <ServiceForm
          service={currentItem}
      ...
      {loading ? (
        ...
        currentItems.length === 0 ? (
          <div className="text-center py-8 text-gray-500">
            {searchQuery ? 'No matching services found.' : 'No services yet. Add your first service!'}
          </div>
        ) : (
          <>
            {/* Table */}
